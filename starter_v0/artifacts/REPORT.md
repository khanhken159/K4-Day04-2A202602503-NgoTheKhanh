...
- Member: Ngô Thế Khanh — 2A202502503
...
- `tools.yaml` phù hợp cho capability boundary, enum, required arguments và phân biệt shared-service/device/KB.
